...
function(add_optimization_settings TARGET_NAME)
    target_compile_options(${TARGET_NAME} PRIVATE
        $<$<OR:$<CXX_COMPILER_ID:GNU>,$<CXX_COMPILER_ID:Clang>>:
            -O3;-march=$<IF:$<STREQUAL:${ARCH_LEVEL},native>,native,x86-64-${ARCH_LEVEL}
        >
        $<$<AND:$<CXX_COMPILER_ID:GNU>,$<BOOL:${ENABLE_LTO}>>:-flto>
        $<$<AND:$<CXX_COMPILER_ID:Clang>,$<BOOL:${ENABLE_LTO}>>:-flto=thin>
    
        $<$<CXX_COMPILER_ID:MSVC>:
            /O2;/Oi;/Ot;/GT;$<$<STREQUAL:${ARCH_LEVEL},v3>:/arch:AVX2>;$<$<STREQUAL:${ARCH_LEVEL},v4>:/arch:AVX512>;$<$<BOOL:${ENABLE_LTO}>:/GL>;/W4;/permissive- 
        >
    )
